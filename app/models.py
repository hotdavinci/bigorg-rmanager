...
class InstagramReel(Base):
    ...
    id: Mapped[int]=mapped_column(primary_key=True); account_id: Mapped[int]=mapped_column(ForeignKey("instagram_accounts.id")); meta_media_id: Mapped[str]=mapped_column(String(100)); caption: Mapped[str]=mapped_column(Text,default=""); permalink: Mapped[str]=mapped_column(String(500),default=""); thumbnail_url: Mapped[str]=mapped_column(String(1000),default=""); video_url: Mapped[str]=mapped_column(String(1500),default=""); published_at: Mapped[datetime|None]=mapped_column(DateTime); views: Mapped[int]=mapped_column(Integer,default=0); likes: Mapped[int]=mapped_column(Integer,default=0); comments: Mapped[int]=mapped_column(Integer,default=0); synced_at: Mapped[datetime]=mapped_column(DateTime,default=datetime.utcnow)
